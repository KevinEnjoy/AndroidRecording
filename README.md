...
这是项目 https://github.com/steelkiwi/AndroidRecording

* 原来的项目是Eclipse的，这里通过Android Studio把它转为idea项目
* 从fft的数据中，计算出frequency

### 注释
* 录音的数据，通过Complex.java的计算，转为fft，这是比较感兴趣的
* 录视频，这部分没用到
